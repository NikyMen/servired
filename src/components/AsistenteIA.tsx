    ...
    <>
      ...
      {!open && (
        <button
          ...
          title="ServiRed IA"
          className={`fixed right-4 bottom-24 z-40 flex size-13 items-center justify-center rounded-full text-white shadow-lg transition-all hover:shadow-xl active:scale-95 md:bottom-6 ${accent} ${accentHover}`}
        >
