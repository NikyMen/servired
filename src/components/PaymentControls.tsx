...
export type Booking = { id: string; note: string | null; status: string; finalPrice: number | null; workSummary: string | null; startedAt: string | null; dueAt: string | null; paymentHandle: string | null; paymentHandleKind: string | null; proposals: Proposal[]; payments: Payment[] };
