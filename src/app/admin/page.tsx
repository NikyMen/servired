...
const TABS = ["todo", "kyc", "denuncias", "usuarios", "trabajos", "catalogo", "publicidad", "soporte", "legales", "preinscripciones"] as const;
...
export default async function AdminPage({ searchParams }: { searchParams: Promise<{ tab?: string }> }) {
  ...
  const [preinscriptions, kycCases, users, bookings, categories, ads, terminos, reports, userCount, verifiedProviderCount, activeJobCount, soporte] = await Promise.all([
    listPreinscriptions(),
